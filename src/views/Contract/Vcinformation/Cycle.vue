...
export default class Cycle extends Vue {
    ...
    public columns: any[] = [{
        ...
        },
        {
            ...
            customRender: (value: any, row: any, index: any) => {
                ...
                const find: any = this.cycleStateOptions.find((item: any) => item.value === value)
                if (find) {
                    obj.children = find.name
                }
                return obj;
    ...
    */
    ...
    //    contractManager,
    //  }
    //  AxiosGet('/contract/vc-information/cycles',{params:SearchOk}).then((res: any) => {
    //           this.data=res.data
    //   })
    //   }
    public SearchOk(values: any): void {
        ...
        AxiosGet('/contract/vc-information/cycles', data).then((res: any) => {
