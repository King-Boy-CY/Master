...
<div>
    ...
    <!-- Number plan -->
    <!-- <Model align-title="center" v-model="showNumberplan" shade title="Client number plan" @Screencover="openNumberplan">
        <template slot="model-body">
            <div>
                <div :style="'margin:10px 20px;'">
                    <div :style="'background:#fff;margin-top:20px;padding:0px 0px;'">
    ...
    <Model align-title="center" v-model="showExcludedestination" shade title="Destination" @Screencover="openExclude">
        <template slot="model-body">
            <div>
                <div :style="'margin:10px 20px;'">
                    <div :style="'background:#fff;margin-top:20px;padding:0px 0px;'">
                    ...
                    <div class="menu-child">
                        <client-source-exclude ref="clientSourceExclude" @confirmExclude="confirmExclude" />
                    </div>
                </div>
            </div>
        </template>
...
export default class ClientSourceAdd extends Vue {
    ...
    public InsertAccount(values ? : any): void {
        ...
        // this.inAccount.map((item: any) => {
        //     this.baseInfoFormOptions[2]["initialValue"] = item.accountName
        // })
        // console.log(this.inAccount[0].accountName)
        this.openAccount()
    }
    /**InsertNumberplan */
    ...
    public created() {
        ...
        this.baseInfoFormOptions[8]["disabled"] = true
        this.baseInfoFormOptions[9]["initialValue"] = ""
        this.baseInfoFormOptions[10]["initialValue"] = "+0800"
        this.baseInfoFormOptions[11]["initialValue"] = ""
        this.baseInfoFormOptions[12]["initialValue"] = ""
        this.baseInfoFormOptions[13]["initialValue"] = ""
        this.baseInfoFormOptions[14]["initialValue"] = ""
        ...
        ClientSourceNameListAdd('').then((res: any) => {
            this.baseInfoFormOptions[4]['options'] = res.data
        })
        // ClientSourceRefList('').then((res: any) => {
        //     this.baseInfoFormOptions[6]["options"] = res.data
        // })
