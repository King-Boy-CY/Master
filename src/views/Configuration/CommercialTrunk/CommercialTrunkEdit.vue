...
export default class CommercialTrunkEdit extends Vue {
    @Prop() addEdit: any;
    ...
    public created() {
        ...
        this.baseInfoFormOptions[0]["initialValue"] = this.addEdit.commercialTrunkName;
        this.baseInfoFormOptions[0]["disabled"] = true;
        this.baseInfoFormOptions[1]["initialValue"] = this.addEdit.technicalTrunkName;
        this.baseInfoFormOptions[2]["initialValue"] = this.addEdit.vendorName;
        this.baseInfoFormOptions[3]["initialValue"] = this.addEdit.accountName;
        this.baseInfoFormOptions[4]["initialValue"] = this.addEdit.status == "Invalid"? 2 : 1;
        this.baseInfoFormOptions[5]["initialValue"] = directionList;
