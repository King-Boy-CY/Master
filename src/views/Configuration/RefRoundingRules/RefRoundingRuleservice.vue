...
export default class vcRoundingRuleservice extends Vue {
    ...
    public actions() {
        ...
        let num: number = 1;
        let a: string = '1\xa0:1\xa0:1\xa0:\xa00:\xa00:';
        this.index++;
        const actions = new Map([
            [1, []],
            [2, ["input", `roundingRuleName${this.index}`, "", a,isDisabled]],
    ...
    public splitChange() {
        this.$nextTick(() => {
        let obj = this.$refs.TableInput.form.getFieldsValue();
        ...
        rulesArr.forEach((elem: any, index: number) => {
            ...
            this.$refs.TableInput.form.setFieldsValue({
                [roundingRuleName]: `${minimumValue || "0"}\xa0:${initialRounding || '0'}\xa0:${additionalRounding || "0"}\xa0:${maximumValue || "0"}\xa0:${measureAdjustment || "0"}\xa0:${isMaximumAsCap === "NO" ? "0" : "" || isMaximumAsCap === "YES" ? "1" : ""}`
            });
            });
            }
        });
